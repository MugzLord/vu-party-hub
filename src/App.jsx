                      ...
                      <td className="p-3 text-right flex justify-end gap-2 items-center text-left">
                          {p.status === 'pending' ? (
                            ...
                            isStaff ? (
                               ...
                               <div className="text-[8px] font-black text-slate-600 uppercase tracking-widest px-2 py-1 bg-white/5 rounded border border-white/5">Hold (Wait for my Signal)</div>
                            ) : (
